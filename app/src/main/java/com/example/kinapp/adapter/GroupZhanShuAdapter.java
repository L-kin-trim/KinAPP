...
public class GroupZhanShuAdapter extends BaseExpandableListAdapter {
    ...
    public GroupZhanShuAdapter(Context context) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.viewButton = convertView.findViewById(R.id.view_button);
            convertView.setTag(holder);
        } else {
        ...
        holder.editButton.setVisibility(showCheckBoxes ? View.GONE : View.VISIBLE);
        holder.viewButton.setVisibility(showCheckBoxes ? View.GONE : View.VISIBLE);
        ...
        holder.viewButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (onViewClickListener != null) {
                    onViewClickListener.onViewClick(item.id);
                }
            }
        });
